$(function () {
	...
	var optionsLine = {
		...
		colors: ["#97BE6D", '#FF9F41', '#337AEE', '#EC41A7'],
		series: [{
			name: "clicks",
			...
			name: "ctr",
			data: [20, 50, 2, 29, 58, 10, 25, 40, 30, 57]
		}, {
			name: "cpc",
			data: [2, 19, 29, 39, 9, 29, 40, 49, 20, 30]
		}],
		title: {
			text: '',
			align: 'left',
		...
		labels: ['Dec 05, 2023', 'Dec 15, 2023', 'Dec 25, 2023', 'Jan 04, 2024', 'Jan 14, 2024', 'Jan 24, 2024', 'Feb 03, 2024', 'Feb 13, 2024', 'Feb 23, 2024', 'Mar 04, 2024'],
		xaxis: {
			// type: 'datetime',
			// categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
		},
