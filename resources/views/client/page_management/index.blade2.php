    ...
    <div class="row">
        ...
        <div class="col-lg-12 mx-auto pb-2" id="btn-align">
            ...
            <a href="javascript:void(0);" class="btn btn-dark float-end copy-zapier-url"
                data-url="{{ route('webhook.save_data', hashids_encode(auth('web')->id())) }}" style="margin-left: 5px;"><img
            ...
            <div class="btn-group float-end">
                <button type="button" class="btn btn-primary split-bg-primary dropdown-toggle dropdown-toggle-split"
                    data-bs-toggle="dropdown" style="margin-right: 5px; border-radius:0.375rem;"> <span class="">Groups </span>
                </button>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content py-3">
                        <div class="tab-pane fade active show" id="allClients" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-3">
                                    <a href="javascript:void(0);" class="btn btn-primary float-end" id="assign_leads_btn">Leads Assign To ISA</a>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="uncontactedLeads" role="tabpanel">
                            <div class="row">
                                {{-- <div class="col">
                                    <input type="hidden" id="uncontacted_leads_count" value="{{ $uncontacted_leads_count }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-12">
                                ...
                                <ul>
                                    <li>Fields other than required fields. <br> Example: <small class="text-danger">Country => Singapore</small></li>
                                </ul>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('user.leads-management.group_save') }}" method="post" id="add_group">
                    @csrf
                    <div class="modal-body">
                        <input class="form-check-input" type="radio" name="group_colour" value="primary" hidden id="colour_1" checked>
                        <input class="form-check-input" type="radio" name="group_colour" value="secondary" hidden id="colour_2">
                        <input class="form-check-input" type="radio" name="group_colour" value="success" hidden id="colour_3">
                        <input class="form-check-input" type="radio" name="group_colour" value="danger" hidden id="colour_4">
                        <input class="form-check-input" type="radio" name="group_colour" value="warning" hidden id="colour_5">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="group_name" id="group_name" value="" placeholder="Enter Group Name" required>
                        </div>
                                ...
                                <div class="col-12 col-lg-12 col-md-12">
                                    <div class="select-picture-container" id="pictureList">
                                        <div class="select-picture-box default_selected">
                                            ...
                                            <img src="{{asset('front')}}/assets/images/group_colours/primary_color.png" width="30px" height="30px" alt="-">
                                        </div>

                                        <div class="select-picture-box">
                                            <i class="bx bx-check"></i>
                                            <div class="selected-ribbon"></div>
                                            <img src="{{asset('front')}}/assets/images/group_colours/secondary_color.png" alt="-">
                                        </div>

                                        <div class="select-picture-box">
                                            <i class="bx bx-check"></i>
                                            <div class="selected-ribbon"></div>
                                            <img src="{{asset('front')}}/assets/images/group_colours/seccess_color.png" alt="-">
                                        </div>

                                        <div class="select-picture-box">
                                            <i class="bx bx-check"></i>
                                            <div class="selected-ribbon"></div>
                                            <img src="{{asset('front')}}/assets/images/group_colours/danger_color.png" alt="-">
                                        </div>

                                        <div class="select-picture-box">
                                            <i class="bx bx-check"></i>
                                            <div class="selected-ribbon"></div>
                                            <img src="{{asset('front')}}/assets/images/group_colours/warning_color.png" alt="-">
                                        </div>

                                        <div class="select-picture-box">
                                            <i class="bx bx-check"></i>
                                            <div class="selected-ribbon"></div>
                                            <img src="{{asset('front')}}/assets/images/group_colours/info_color.png" alt="-">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('user.leads-management.group_save') }}" method="post" id="edit_group">
                    @csrf
                    <div class="modal-body">
                        <input class="form-check-input" type="radio" name="edit_group_colour" value="primary" hidden id="edit_colour_1">
                        <input class="form-check-input" type="radio" name="edit_group_colour" value="secondary" hidden id="edit_colour_2">
                        <input class="form-check-input" type="radio" name="edit_group_colour" value="success" hidden id="edit_colour_3">
                        <input class="form-check-input" type="radio" name="edit_group_colour" value="danger" hidden id="edit_colour_4">
                        <input class="form-check-input" type="radio" name="edit_group_colour" value="warning" hidden id="edit_colour_5">
                        <input class="form-check-input" type="radio" name="edit_group_colour" value="info" hidden id="edit_colour_6">
                        <input type="hidden" name="edit_group_id" id="edit_group_id">

                        <div class="form-group mb-3">
                            <label for="">Gruop Name</label>
                            <input type="text" class="form-control" name="group_name" id="edit_group_name" placeholder="Enter Group Name" required>
                        </div>
                                ...
                                <tbody>
                                    @forelse ($client_groups as $k => $group)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0);" class="text-warning edit-group" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit Group" data-bs-original-title="Edit Group" aria-label="Edit" data-data="{{ $group }}"><i class="bi bi-pencil-fill"></i></a>
                                                <a class="text-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete" data-bs-original-title="Delete" aria-label="Delete" href="javascript:void(0);" onclick="ajaxRequest(this)" data-url="{{ route('user.leads-management.delete_group', $group->id) }}"><i class="bi bi-trash-fill"></i></a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
