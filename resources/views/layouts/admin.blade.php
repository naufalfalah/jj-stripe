...
<head>
    ...
    <!-- Jquery Confirm -->
    <!-- <link href="{{ asset('front') }}/assets/plugins/jquery-confirm/jquery-confirm.min.css" rel="stylesheet" type="text/css" /> -->
...
<body>
    ...
    <!-- Jquery Confirm -->
    <!-- <script src="{{ asset('front') }}/assets/plugins/jquery-confirm/jquery-confirm.min.js"></script> -->
