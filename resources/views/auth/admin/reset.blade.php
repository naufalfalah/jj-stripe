            ...
            <div class="row g-0">
              <div class="col-lg-12">
                <div class="card-body p-4 p-sm-5">
                  ...
                  <form class="form-body" method="POST" action="{{ route('admin.save_new_password') }}">
                        @csrf
                      <div class="row g-3">
                        <div class="col-12">
                          ...
                          <div class="ms-auto position-relative">
                            ...
                            <input type="password" class="form-control radius-30 ps-5" name="password" value="{{ old('password') }}" id="inputNewPassword" placeholder="Enter Password" required>
                            @error('password')
                        ...
                        <div class="col-12">
                          ...
                          <div class="ms-auto position-relative">
                            <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bi bi-lock-fill"></i></div>
                            <input type="password" class="form-control radius-30 ps-5" name="confirm_password" value="{{old('confirm_password')}}" id="inputConfirmPassword" placeholder="Confirm Password">
                        ...
                        <div class="col-12">
                          <div class="d-grid gap-3">
                            ...
                            <button type="submit" class="btn btn-primary radius-30">Save Password</button>
                          </div>
                        </div>
                      </div>
                  </form>
