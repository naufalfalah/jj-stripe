                    ...
                    <div class="border p-4 rounded">
                        ...
                        <form method="POST" action="{{ route('admin.notification.store') }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="title" id="title" value="{{ $notification->title ?? '' }}" placeholder="Enter Title" class="form-control" required>
                            </div>
                            <div class="col-md-12">
                                <label for="body">Body<span class="text-danger">*</span></label>
                                <input type="text" name="body" id="body" value="{{ $notification->body ?? '' }}" placeholder="Enter Body" class="form-control" required>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="form-group mb-3 text-right">
                                <input type="hidden" name="id" value="{{ $notification->id ?? null }}">
