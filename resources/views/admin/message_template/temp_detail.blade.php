...
<div class="page-breadcrumb d-flex align-items-center mb-2">
    ...
    <a href="{{route('admin.message-template.all')}}" class="btn btn-dark"><i class="fa-solid fa-angle-left"></i> Back</a>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('user.message-template.send') }}" method="post" id="messageSendForm">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <a href="https://wa.me/1234567890?text=Hello%20World" target="_blank" id="whatsapp_link" type="submit" class="btn btn-primary form-submit-btn">Send</a>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    $(document).on('change', '.single-select', function () {
        ...
        var tempMessage = $("#client_desc").val();
