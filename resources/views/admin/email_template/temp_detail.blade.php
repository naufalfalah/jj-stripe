...
<div class="page-breadcrumb d-flex align-items-center mb-3 mt-5">
    ...
    <a href="{{route('admin.email-template.all')}}" class="btn btn-dark"><i class="fa-solid fa-angle-left"></i> Back</a>
    ...
    <div class="ms-auto">
        ...
        <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">
                ...
                <a class="dropdown-item text-danger" href="javascript:void(0);" onclick="ajaxRequest(this)" data-url="{{route('admin.email-template.delete',$data->hashid)}}">Delete email template</a>
            </div>
        </div>
    </div>
</div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="fs-5 ms-auto dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item text-success edit-activity float-end"  href="{{ route('admin.lead-management.client_details', hashids_encode($item->client_id)) }}">Go To Client Detail</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
...
<div class="modal fade" id="templateNoteModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.email-template.save') }}" method="post" id="templateNoteForm">
                @csrf
...
<div class="modal fade" id="sendTemplateModal" tabindex="-1" aria-labelledby="sendTemplateModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.email-template.send') }}" method="post" id="messageSendForm">
                @csrf
                <div class="modal-body">
                            ...
                            <tbody>
                                @forelse ($data->message_activity as $k => $share)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.lead-management.client_details', hashids_encode($share->client_id)) }}" class="text-success" data-bs-toggle="tooltip" data-bs-placement="bottom" title="View Lead" data-bs-original-title="View Lead" aria-label="View" ><i class="bi bi-eye-fill"></i></a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
...
<script>
    ...
    $(document).on('change', '.single-select', function () {
        ...
        $("#email_send_btn").attr("href", mailtoLink);
    });
    ...
    $(".copy-template").click(function () {
        ...
        var url = "{{ route('admin.email-template.copy_temp') }}";
