...
@push('scripts')
    <script>
        ...
        function getCampaigns() {
            $('#campaign-table-body').empty()

            if (clientId) {
                $.ajax({
                    url: "{{ route('google_ads.campaign') }}",
                    method: 'GET',
                    data: {
                        client_id: clientId,
                    },
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                                <a href="{{ route('admin.sub_account.client-management.google_ads_campaign.edit', ['sub_account_id' => $sub_account_id]) }}?client_id=${clientId}&campaign_resource_name=${campaign.campaign.resourceName}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" aria-label="Edit"><i class="bi bi-pencil-fill"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                `);
