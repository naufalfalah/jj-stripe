                ...
                <div class="card shadow">
                    <div class="card-body">
                        <div class="border p-4 rounded">
                            ...
                            <hr />
                            <form method="POST" action="{{ route('admin.message_template.wp_message_store') }}" class="row g-3 ajaxForm">
                                @csrf
                                <div class="col-md-12">
                                    <label for="">Enter Number</label>
                                    <input type="text" name="from_number" id="wp_message_number" cols="30" rows="3" class="form-control" placeholder="Enter Number" value="{{ $whatsapp_temp->from_number ?? '' }}" oninput="validateNumberInput(this)">
...
<script>
    ...
    if (currentValue !== input.value) {
        alert('Please enter the Numeric mobile phone numbers');
    }
}
